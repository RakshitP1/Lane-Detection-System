...
class Model:
    ...
    def __init__(self, layers = [
        ...
        BatchNormalization(input_shape=(80, 160, 3)),
        ...
        # # Deconv 3
        Conv2DTranspose(1, (3, 3), padding='valid', strides=(1,1), activation = 'relu', name = 'Deconv3'),
        # Dropout(0.2),
    ...
    def train_model(self, batch_size = 128, epochs = 1, input_shape = (480, 640, 3), training_image_path='training_images.p', labeled_image_path='labeled_images.p'):
...
def main():
    ...
    cnn_model.train_model(epochs=1,input_shape=(80, 160, 3))

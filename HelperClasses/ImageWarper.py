...
class ImageWarper():
    ...
    def __init__(self, transformed_dimensions: list):
        ...
        self.height = transformed_dimensions[0]
        self.width = transformed_dimensions[1]
    ...
    def get_perspective_transform(self, image, region_of_interest: list, transformed_dimensions: list):
        ...
        region_of_interest[1], region_of_interest[0] = region_of_interest[0], region_of_interest[1]
        print(region_of_interest)
        # Make array float32
        ...
        self.inverse_transformation_matrix = cv2.getPerspectiveTransform(transformed_image, region_of_interest)

        return (self.tranformation_matrix, self.inverse_transformation_matrix)

    def warp_image(self, image):

        warped_image = cv2.warpPerspective(image, self.tranformation_matrix, (self.width,self.height), flags=(cv2.INTER_CUBIC))
        return warped_image
